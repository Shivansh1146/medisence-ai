      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-4 hover:opacity-80 transition">
            ...
            <span className="text-2xl font-bold text-gray-900">MedicSense AI</span>
          </Link>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          {/* Phone Sign In */}
          {authMode === 'phone' && (
            <form onSubmit={confirmationResult ? handleVerifyOTP : handlePhoneSignIn} className="space-y-4">
              {!confirmationResult ? (
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Phone Number
          ...
          {(authMode === 'signin' || authMode === 'signup') && (
            <div className="space-y-3">
              ...
              <div className="relative my-4">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-gray-500">No account needed</span>
                </div>
              </div>
